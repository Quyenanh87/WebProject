<%-- 
    Document   : register
    Created on : Nov 18, 2023, 6:28:21 PM
    Author     : tranp
--%>
          ...
          <div class="login-form text-center ">
            ...
            <form action="/login" method="post">
              ...
              <div class="form-group login_pass">
                <input name="address" class="form-control form-control-lg form-control-rounded text-center" type="text"
                  placeholder="Địa chỉ">
                <span class="ajax-message-error "></span>
              </div>
              <div class="form-group login_pass">
                <input name="email" class="form-control form-control-lg form-control-rounded text-center" type="text"
                  placeholder="Địa chỉ email">
                <span class="ajax-message-error "></span>
              </div>
              <div class="form-group login_pass">
                <input name="phone" class="form-control form-control-lg form-control-rounded text-center" type="text"
                  placeholder="Số điện thoại">
                <span class="ajax-message-error "></span>
              </div>
              <div class="form-group login_pass">
                <input name="password" class="form-control form-control-lg form-control-rounded text-center" type="text"
                  placeholder="Mật khẩu">
                <span class="ajax-message-error "></span>
              </div>
              <div class="form-group login_pass">
                <input name="repassword" class="form-control form-control-lg form-control-rounded text-center"
              ...
              <div class="mb-2 text-left">
                <div class="check_a">
                  <label class="custom-control custom-checkbox mb-0 ">
                    <input class="custom-control-input" type="checkbox" checked="" name="check_a">
                    <span class="custom-control-label font-13">Tôi đã đọc và đồng ý với các <a
                        class="text-primary" href="dieu-khoan-su-dung.jsp" target="_blank">Điều khoản</a> của
                      aqtbaby.com</span>
                  </label>
                ...
                <div class="check_b">
                  <label class="custom-control custom-checkbox mb-0 ">
                    <input class="custom-control-input" type="checkbox" checked="" name="check_b">
                    <span class="custom-control-label font-13">Tôi đã đọc và đồng ý với <a class="text-primary"
                        href="chinh-sach-bao-mat.jsp" target="_blank">Chính sách bảo vệ thông tin cá nhân</a>
                      của aqtbaby.com</span>
                  </label>
                  <span class="ajax-message-error font-12"></span>
                </div>
              </div>
              <div class="login-form text-center">
                <a class="btn btn-secondary btn-rounded btn-lg btn-block btn-pink" href="dang-ky.jsp"><span
                    class="text-white">ĐĂNG KÝ</span></a>
              </div>
            </div>
            <div class="login-bottom mt-5">
              <div class="container">
                <div class="login-form text-center">
                  <p>Đã có tài khoản</p><a class="btn btn-secondary btn-rounded btn-lg btn-block btn-white"
                    href="https://concung.com/dang-nhap.jsp">
                    <span class="text-primary">ĐĂNG NHẬP</span></a>
                  <a class="btn btn-link btn-block text-primary" href="https://concung.com/reset-password.jsp">Quên
                    mật khẩu?</a>
                </div>
              </div>
            </div>
