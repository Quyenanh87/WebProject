<%-- 
    ...
    Created on : Nov 18, 2023, 6:28:29 PM
    Author     : tranp
--%>
    ...
    <section>
      <div class="container">
        <div class="row mb-4 py-5">
          <div class="login-form text-center py-5">
            <h2 class="the-title">Lấy lại mật khẩu</h2>
            <div class="form-group resetpass_error">
              <span class="ajax-message-error "></span>
            </div>
            <div class="form-group phone_registry">
              <input class="form-control form-control-lg form-control-rounded text-center" maxlength="10" type="text"
                name="phone_registry" placeholder="Vui lòng nhập số điện thoại">
              <span class="ajax-message-error "></span>
            </div>
            <a class="btn btn-primary btn-lg btn-block resset_pass_otp" href="#"><strong>Gửi</strong></a>
          </div>
        </div>
      </div>
    </section>
